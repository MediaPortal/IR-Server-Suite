...
namespace IrssCommands.General
{
  ...
  /// </summary>
  public class VirtualKeyboardCommand : Command
  {
    #region Constructors

    /// <summary>
    /// Initializes a new instance of the <see cref="VirtualKeyboardCommand"/> class.
    /// </summary>
    public VirtualKeyboardCommand()
    {
      InitParameters(0);
    }
    ...
    public VirtualKeyboardCommand(string[] parameters)
      : base(parameters)
    {
    }
