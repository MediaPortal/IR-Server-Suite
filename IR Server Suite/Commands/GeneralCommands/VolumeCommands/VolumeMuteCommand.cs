...
namespace IrssCommands.General
{
  ...
  /// </summary>
  public class VolumeMuteCommand : Command
  {
    #region Constructors

    /// <summary>
    /// Initializes a new instance of the <see cref="VolumeMuteCommand"/> class.
    /// </summary>
    public VolumeMuteCommand()
    {
      InitParameters(0);
    }
    ...
    public VolumeMuteCommand(string[] parameters)
      : base(parameters)
    {
    }
