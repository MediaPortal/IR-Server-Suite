...
namespace IrssCommands.General
{
  ...
  public class BeepCommand : Command
  {
    ...
    public BeepCommand(string[] parameters)
      : base(parameters)
    {
    }
    ...
    {
      return new BeepConfig(Parameters);
    }
    ...
    public override void Execute(VariableList variables)
    {
      ...
      int frequency = int.Parse(processed[0]);
      int duration = int.Parse(processed[1]);

      Win32.PlayBeep(frequency, duration);
    }
