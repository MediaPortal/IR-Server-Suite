...
namespace IRServer.Plugin.Hardware
{
  public class Remote : Device
  {
    ...
    private void Init()
    {
      ...
      {
        MCEBasic.Debug.WriteLine("Remote.Init: {0}", e.Message);
      }
    }
    ...
    protected override void Open()
    {
      ...
      if (LogVerbose)
      {
        MCEBasic.Debug.WriteLine("MCE: Using: {0}", devicePath);
      }
    ...
    {
      MCEBasic.Debug.WriteLine("MCE: asyncResult:");
      try
      {
        int valEndRead;
        int devBufIndex;
        if (
          OSInfo.OSInfo.Win7OrLater())
        {
          valEndRead = 25;
          devBufIndex = 9;
        }
