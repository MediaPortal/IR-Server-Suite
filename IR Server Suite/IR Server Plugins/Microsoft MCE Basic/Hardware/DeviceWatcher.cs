...
namespace IRServer.Plugin.Hardware
{
  internal class DeviceWatcher : NativeWindow
  {
    ...
    internal void RegisterDeviceArrival()
    {
      ...
      {
        MCEBasic.Debug.WriteLine("DeviceWatcher.RegisterDeviceArrival: Error={0}.", Marshal.GetLastWin32Error());
      }
    ...
    internal void RegisterDeviceRemoval(SafeHandle deviceHandle)
    {
      ...
      {
        MCEBasic.Debug.WriteLine("DeviceWatcher.RegisterDeviceRemoval: Error={0}.", Marshal.GetLastWin32Error());
      }
