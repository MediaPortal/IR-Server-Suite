...
namespace IRServer.Plugin
{
  internal partial class ConfigurationDialog : Form
  {
    ...
    public ConfigurationDialog()
    {
      ...
      try
      {
        checkBoxDisableAutomaticButtons.Checked = !MCEBasic.CheckAutomaticButtons();
      }
      catch
      {
