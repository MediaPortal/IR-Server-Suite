...
namespace InputService.Plugin
{
  ...
  internal class DriverXP : Driver
  {
    ...
    public DriverXP(Guid deviceGuid, string devicePath, RemoteCallback remoteCallback, KeyboardCallback keyboardCallback,
    ...
    private void ReadThread()
    {
      ...
      try
      {
        ...
        while (_readThreadMode != ReadThreadMode.Stop)
        {
          ...
          bool readDevice = ReadFile(_eHomeHandle, deviceBufferPtr, DeviceBufferSize, out bytesRead,
