...
namespace Commands
{
  ...
  /// <summary>
  /// Maths Modulo macro command.
  /// </summary>
  public class CommandMathsModulo : Command
  {

    #region Constructors

    /// <summary>
    /// Initializes a new instance of the <see cref="CommandMathsModulo"/> class.
    /// </summary>
    public CommandMathsModulo() { InitParameters(3); }

    /// <summary>
    /// Initializes a new instance of the <see cref="CommandMathsModulo"/> class.
    /// </summary>
    /// <param name="parameters">The parameters.</param>
    public CommandMathsModulo(string[] parameters) : base(parameters) { }
    ...
    public override string GetUserInterfaceText() { return "Maths Modulo"; }
