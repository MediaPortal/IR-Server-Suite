...
namespace WiimoteLib
{
  ...
  public class Wiimote : IDisposable
  {
    ...
    ///</summary>
    [Obsolete(
      "The Connect method will determine the proper write method at runtime.  Only set this if you really want to force it."
      )]
    ...
    private void BeginAsyncRead()
    {
      ...
      if (mStream.CanRead)
      {
        ...
        mStream.BeginRead(buff, 0, REPORT_LENGTH, OnReadData, buff);
      }
    }
        ...
        case InputReport.Status:
          ...
          if (mWiimoteState.Extension != extension)
          {
            ...
            if (WiimoteExtensionChanged != null)
              WiimoteExtensionChanged(this,
                                      new WiimoteExtensionChangedEventArgs(mWiimoteState.ExtensionType,
                                                                           mWiimoteState.Extension));
          }
...
//					mWiimoteState.ClassicControllerState.AccelCalibrationInfo.MaxTriggerR = (byte)(buff[15] >> 3);
    ...
    private void ParseExtension(byte[] buff, int offset)
    {
      switch (mWiimoteState.ExtensionType)
      {
        ...
        case ExtensionType.ClassicController:
          ...
          mWiimoteState.ClassicControllerState.RawXR =
    ...
    {
      if (mAltWriteMethod)
        HIDImports.HidD_SetOutputReport(mHandle.DangerousGetHandle(), mBuff, (uint) mBuff.Length);
      else
    ...
    #region Nested type: OutputReport
