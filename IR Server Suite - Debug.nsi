...
SkipUninstallInputService:
  ...
  File "IR Server Plugins\CoolCommand Receiver\bin\Debug\CoolCommand Receiver.*"
  ...
  File "IR Server Plugins\IgorPlug Receiver\bin\Debug\IgorPlug Receiver.*"
  ;File "IR Server Plugins\IR501 Receiver\bin\Debug\IR501 Receiver.*"
  File "IR Server Plugins\IR507 Receiver\bin\Debug\IR507 Receiver.*"
  ;File "IR Server Plugins\Ira Transceiver\bin\Debug\Ira Transceiver.*"
  File "IR Server Plugins\IRMan Receiver\bin\Debug\IRMan Receiver.*"
  File "IR Server Plugins\IRTrans Transceiver\bin\Debug\IRTrans Transceiver.*"
  ;File "IR Server Plugins\Keyboard Input\bin\Debug\Keyboard Input.*"
  File "IR Server Plugins\LiveDrive Receiver\bin\Debug\LiveDrive Receiver.*"
  File "IR Server Plugins\MacMini Receiver\bin\Debug\MacMini Receiver.*"
  File "IR Server Plugins\Microsoft MCE Transceiver\bin\Debug\Microsoft MCE Transceiver.*"
  ;File "IR Server Plugins\RC102 Receiver\bin\Debug\RC102 Receiver.*"
  File "IR Server Plugins\RedEye Blaster\bin\Debug\RedEye Blaster.*"
  File "IR Server Plugins\Serial IR Blaster\bin\Debug\Serial IR Blaster.*"
  ;File "IR Server Plugins\Speech Receiver\bin\Debug\Speech Receiver.*"
  File "IR Server Plugins\Technotrend Receiver\bin\Debug\Technotrend Receiver.*"
  ;File "IR Server Plugins\Tira Transceiver\bin\Debug\Tira Transceiver.*"
  File "IR Server Plugins\USB-UIRT Transceiver\bin\Debug\USB-UIRT Transceiver.*"
  File "IR Server Plugins\Wii Remote Receiver\bin\Debug\Wii Remote Receiver.*"
  File "IR Server Plugins\WiimoteLib\bin\Debug\WiimoteLib.*"
...
Section "Virtual Remote" SectionVirtualRemote
  ...
  File "Applications\Web Remote\bin\Debug\WebRemote.*"
  File "Applications\Virtual Remote Skin Editor\bin\Debug\VirtualRemoteSkinEditor.*"
  ...
  SetOverwrite ifnewer
  File "Applications\Virtual Remote (PocketPC2003) Installer\Debug\*.cab"
  File "Applications\Virtual Remote (Smartphone2003) Installer\Debug\*.cab"
  File "Applications\Virtual Remote (WinCE5) Installer\Debug\*.cab"
...
Section "Keyboard Input Relay" SectionKeyboardInputRelay
  ...
  SetOverwrite ifnewer
  File "Applications\Keyboard Input Relay\bin\Debug\*.*"
...
Section "Dbox Tuner" SectionDboxTuner
  ...
  SetOverwrite ifnewer
  File "Applications\Dbox Tuner\bin\Debug\*.*"
...
Section "HCW PVR Tuner" SectionHcwPvrTuner
  ...
  SetOverwrite ifnewer
  File "Applications\HCW PVR Tuner\bin\Debug\*.*"
