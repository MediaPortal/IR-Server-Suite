...
SkipUninstallInputService:
  ...
  File "IR Server Plugins\IgorPlug Receiver\bin\Release\IgorPlug Receiver.dll"
  File "IR Server Plugins\IR501 Receiver\bin\Release\IR501 Receiver.dll"
  ...
  File "IR Server Plugins\Serial IR Blaster\bin\Release\Serial IR Blaster.dll"  
  File "IR Server Plugins\USB-UIRT Transceiver\bin\Release\USB-UIRT Transceiver.dll"
  File "IR Server Plugins\Wii Remote Receiver\bin\Release\Wii Remote Receiver.dll"
  File "IR Server Plugins\WiimoteLib\bin\Release\WiimoteLib.dll"
  File "IR Server Plugins\Windows Message Receiver\bin\Release\Windows Message Receiver.dll"
  File "IR Server Plugins\WinLirc Transceiver\bin\Release\WinLirc Transceiver.dll"
  File "IR Server Plugins\X10 Transceiver\bin\Release\X10 Transceiver.dll"
  File "IR Server Plugins\X10 Transceiver\bin\Release\Interop.X10.dll"
  File "IR Server Plugins\XBCDRC Receiver\bin\Release\XBCDRC Receiver.dll"
