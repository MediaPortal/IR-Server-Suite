...
namespace IrssComms
{
  ...
  public class Message
  {
    ...
    public Message(MessageType type, MessageFlags flags)
      : this()
    {
      _type   = type;
      _flags  = flags;
    ...
    public Message(MessageType type, MessageFlags flags, byte[] data)
      : this(type, flags)
    {
      _data = data;
    }

    public Message(MessageType type, MessageFlags flags, string data)
      : this(type, flags)
    {
    ...
    public static Message FromBytes(byte[] from)
    {
      if (from == null)
      ...
      else
      {
        ...
        return new Message(type, flags, data);
      }
    }
