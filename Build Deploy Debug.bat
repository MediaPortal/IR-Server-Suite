...
"%progpath%\Microsoft Visual Studio 8\Common7\IDE\devenv.com" /rebuild Debug "IR Server Suite.sln" >> build_debug.log
...
DEL version.txt
"%progpath%\NSIS\makensis.exe" /DVER_BUILD=%version% setup\setup.nsi >> build_debug.log